...
|---------|-------------------|------------|-------|
| **Side-by-side outlier reduction comparison** | BERTopic creates -1 outliers; comparing reduction strategies (probabilities, distributions, c-TF-IDF, embeddings) side-by-side helps users make informed decisions without trial-and-error | MEDIUM | Run 2-4 strategies in parallel, display before/after topic counts, outlier %, and sample document reassignments |
